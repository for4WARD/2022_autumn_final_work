...
int AI::mark_giver_white(ChessNode ** chesses,int size,int x,int y){
    Algorithm algorithm;
    string *str=mark_giver_scanner(chesses,size,x,y,algorithm);
    int ans=0;
    int container[8];//能赢 活四，活三，活二 赋分 10000 100 10     防守： 对方 眠四 活三 双三 活二
...
//            cout<<"check4:b"<<x<<"\t"<<y<<endl;
        ...
        if((l4=="nnn?"&&r1=="?")||(r4=="nnn?"&&l1=="?")||(l3=="nn?"&&r2=="n?")||(r3=="nn?"&&l2=="n?")){
            return INT32_MAX-2;
        }
        if((l4=="nnn"&&r1=="?")||(r4=="nnn?")||(l3=="nn?"&&r2=="n")||(r3=="nn"&&l2=="n?")){
            return container[1]+=1;//眠四
        }
        if((l3=="nn?"&&r1=="?")||(l2=="n?"&&r2=="n?")||(l1=="?"&&r3=="nn?"))
        {
...
//            cout<<"check4:"<<x<<"\t"<<y<<endl;
        ...
        if((l4=="fff?")||(r4=="fff?")||(l3=="ff?"&&r1=="f")||(r3=="ff?"&&l1=="f")){
//            cout<<"check3:"<<x<<"\t"<<y<<endl;
            return INT32_MAX-3;//不堵就寄
        }
        if((l3=="fff"&&r1=="?")||(r4=="fff?")||(l3=="ff?"&&r2=="f")||(r3=="ff"&&l2=="f?")){
            return container[5]+=1;//5：眠四
        }
        if((l3=="ff?"&&r1=="?")||(l2=="f?"&&r2=="f?")||(l1=="?"&&r3=="ff?"))
        {
...
int AI::Strategy_maker_white(ChessBoard board,int size){
